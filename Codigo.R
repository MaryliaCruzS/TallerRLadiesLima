...
boxplotVarones <- ggplot(DataConteo, aes(x=0, y=Porcentaje_Varones))
boxplotVarones + geom_boxplot(aes(fill=factor(anio))) + theme_bw()+ylim(0,100)
...
BoxplotDataConteoAlcades <- ggplot(DataConteoAlcades, aes(x=0, y=Porcentaje_Mujeres))
BoxplotDataConteoAlcades + geom_boxplot(aes(fill=factor(anio))) + theme_bw()+ylim(0,1)


BoxplotDataConteoAlcades <- ggplot(DataConteoAlcades, aes(x=0, y=Porcentaje_Varones))
BoxplotDataConteoAlcades + geom_boxplot(aes(fill=factor(anio))) + theme_bw()+ylim(0,1)
